...
class WorkerApp:
    ...
    def setup_tasks2_table(self):
        ...
        self.task2_table.column('#1', width=50, stretch=NO)
        self.task2_table.column('#2', width=200, stretch=NO)
        self.task2_table.column('#3', width=100, stretch=NO)
        # self.task2_table.column('#4', width=100, stretch=NO)
            ...
            if new_status:
                try:
                    ...
                    if new_status == 'Complete':
                        mb.showinfo("Task Update", "The task has been marked as Complete!")
